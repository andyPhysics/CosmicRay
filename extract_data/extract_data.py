...
def get_Xmax(depth,num):
    popt,pcov = curve_fit(Gaisser_hillas_function,depth[0:len(depth)-2],num[0:len(num)-2],bounds=((0,0,0,0),(np.inf,np.inf,np.inf,min(depth))))
#    print(popt,pcov)
    return popt
...
def read_root_files(files,input_mass):
    ...
    for i in files:
        ...
        for i in range(depth.shape[0]):
            ...
            xmax.append(prediction[1]/prediction[2]+prediction[3])
