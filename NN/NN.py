...
model1 = Dense(7,activation='tanh',use_bias=True,bias_initializer=initializers.Constant(0))(input_layer)

model1 = Dropout(rate=0.1)(model1)

model1 = Dense(4,activation='tanh',use_bias=True,bias_initializer=initializers.Constant(0))(model1)
